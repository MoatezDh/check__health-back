...
SECRET_KEY = 'django-insecure-$i5mcab3iei(rfvaf*aj=z2l9ij2mt9#dtdu+w@8)fwhv+)t#c'
...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {"name": "Support", "url": "https://github.com/MoatezDh", "new_window": True},
